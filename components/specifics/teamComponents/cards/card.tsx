...
export default function Card({ team, open, setRefreshKey } : { team: teamSavedInfo, open: boolean, setRefreshKey: Function }) {
  ...
  const mystyle={
    background: 'linear-gradient(to top right, #FFFFFF 50%, '+team.color+' 190%)'
  }

  return (
    <div className="border hover:border-slate-600 p-4 transition rounded shadow-sm" style={mystyle}>
