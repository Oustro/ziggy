...
export default async function DashboardNav() {
  ...
  return (
    <>
      <nav className="hidden sm:block sticky top-0 left-0 w-[250px] h-screen relative border-r px-6">
      ...
      <nav className="sm:hidden sticky text-sm top-0 z-50 w-full backdrop-blur from-white-50 h-16 border-b px-6 flex items-center justify-between">
