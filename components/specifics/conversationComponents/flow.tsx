...
export default function Flow({ interviewData } : { interviewData: any }) {
  ...
  const [finishedInterview, setFinishedInterview] = useState<boolean>(false)
  ...
  const views = [
    ...
    <TextStyle key="textStle" interviewInfo={interviewData} interviewee={interviewee} setMostRecentQuestion={setMostRecentQuestion} finishedInterview={finishedInterview} setFinishedInterview={setFinishedInterview} />,
    <FormStyle key="formStyle" interviewInfo={interviewData} interviewee={interviewee} setMostRecentQuestion={setMostRecentQuestion} finishedInterview={finishedInterview} setFinishedInterview={setFinishedInterview} />
  ]
